    ...
    return (
        <div className="d-flex flex-column col-2  sidebar "  >
            <IconContext.Provider value={{ color: '#fff' }}>
                ...
                <NavbarBrand className="p-2  display-head  m-2"> <NavLink to='/home' className="text-light text-decoration-none" >Today</NavLink></NavbarBrand>
                <Nav navbar>
                    ...
                    <NavItem className="p-2  display-4 mt-7 p-3 text-center">
